...
public interface ComptabiliteDao {
    ...
    /**
     * Renvoie Sequence d'écriture comptable
     *
     * @param code
     * @param annee
     * @return
     ...
     */
    SequenceEcritureComptable getSequenceEcritureComptable(String code, int annee) throws NotFoundException;
    ...
    /**
     * Met à jour la séquence comptable
     *
     * @param sequence
     */
   ...
   // ==================== JournalComptable ====================
     ...
     */
    void insertJournalComptable(JournalComptable journalComptable);
