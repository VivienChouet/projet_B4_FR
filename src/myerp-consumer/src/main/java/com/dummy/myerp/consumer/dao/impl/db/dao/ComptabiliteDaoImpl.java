...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    @Override
    public SequenceEcritureComptable getSequenceEcritureComptable(String code, int annee) throws NotFoundException {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        vSqlParams.addValue("journal_code", code);
        vSqlParams.addValue("journal_annee", annee);
        ...
        try {
            ...
            throw new NotFoundException("SequenceEcritureComptable non trouvé: codeJournal = "
                    + code + ", année= " + annee + " '.");
        }
        return vBean;
    }
    ...
    private void setSQLinsertSequenceEcritureComptable(String pSQLinsertSequenceEcritureComptable){
    ...
    public void insertSequenceEcritureComptable(SequenceEcritureComptable sequenceEcritureComptable) {
        ...
        vSqlParams.addValue("journal_annee",sequenceEcritureComptable.getAnnee());
    ...
    // ==================== SequenceEcritureComptable - Update ====================
        ...
        /**
         /**
         * update la SequenceEcritureComptable
         * @param pSequenceEcritureComptable séquence de l'écriture comptable
         */
        @Override
        public void updateSequenceEcritureComptable(SequenceEcritureComptable pSequenceEcritureComptable) {
            ...
            vSqlParams.addValue("journal_annee", pSequenceEcritureComptable.getAnnee());
    ...
    @Override
    public void insertJournalComptable(JournalComptable journalComptable) {
